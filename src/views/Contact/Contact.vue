        ...
        <div class="container">
            <div class="header-wrapper">
                ...
                <div class="header-img">
                    <img src="https://huquqiyportal.uz/_nuxt/img/phone-icon.9be8f1f.png" alt="foto">
                </div>
            </div>
        </div>
    </div>
       ...
       <div class="container">
        <div class="main-wrapper">
            <!-- <div class="main-content">
                ...
                <div class="main-tel">
                    <a href="!#" target="_blank" rel="noopener noreferrer">+998940206569</a>
                    <a href="!#" target="_blank" rel="noopener noreferrer">+998940566569</a>
                </div>
                <h2>
                    E-mainl
                </h2>
                <a class="con-email" href="!#" target="_blank" rel="noopener noreferrer">Mdqw@gmail.com</a>
                <h2>
                    Ijtimoyi tarmoqlar
                </h2>
