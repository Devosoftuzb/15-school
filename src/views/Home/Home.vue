        ...
        <div class="container">
            ...
            <div class="map-wrapper">
                <div class="map-img">
                    ...
                    <svg class="map-uz" xmlns:mapsvg="http://mapsvg.com" xmlns:dc="http://purl.org/dc/elements/1.1/"
                        ...
                        <path @mouseover="changeValu"
                            ...
                            class="water" title="Aral Sea" id="UZ-AS"></path>
                        <path
                            ...
                            title="Sarvan (Sughd Province, Tajikistan)" id="TJ-SU" class=" mapsvg-region"
                            style="fill: #C8C8C8; stroke: #C8C8C8; stroke-width: 1.0233px;"></path>
                        <path
                            ...
                            title="Andijon" id="UZ-AN" class=" mapsvg-region"></path>
                        <path
                            ...
                            title="Buxoro" id="UZ-BU" class=" mapsvg-region"></path>
                        <path
                            ...
                            title="Farg‘ona" id="UZ-FA" class=" mapsvg-region"></path>
                        <path
                            ...
                            title="Jizzax" id="UZ-JI" class=" mapsvg-region"></path>
                        <path
                            ...
                            title="Namangan" id="UZ-NG" class=" mapsvg-region"></path>
                        <path
                            ...
                            title="Navoiy" id="UZ-NW" class=" mapsvg-region"></path>
                        <path
                            ...
                            title="Qashqadaryo" id="UZ-QA" class=" mapsvg-region"></path>
                        <path
                            ...
                            title="Qoraqalpog‘iston Respublikasi" id="UZ-QR" class=" mapsvg-region"></path>
                        <path
                            ...
                            title="Samarqand" id="UZ-SA" class=" mapsvg-region"></path>
                        <path
                            ...
                            title="Sirdaryo" id="UZ-SI" class=" mapsvg-region"></path>
                        <path
                            ...
                            title="Surxondaryo" id="UZ-SU" class=" mapsvg-region"></path>
                        <path
                            ...
                            title="Toshkent City" id="UZ-TK" class=" mapsvg-region"></path>
                        <path
                            ...
                            title="Toshkent" id="UZ-TO" class=" mapsvg-region"></path>
                        <path
                            ...
                            title="Xorazm" id="UZ-XO" class=" mapsvg-region"></path>
                    </svg>
                </div>
