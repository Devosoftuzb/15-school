    ...
    <section class="Teacher">
        <div class="container">
            <div class="teacher-title">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="m12 18.26l-7.053 3.948l1.575-7.928L.588 8.792l8.027-.952L12 .5l3.385 7.34l8.027.952l-5.934 5.488l1.575 7.928z"/></svg>
                <div class="teacher-title-line"></div>
                </div>
                <h1>
                    Elected Officials
            ...
            <div class="teacher-wrapper">
                <div class="teacher-foto">
                    <img src="https://www.ms.gov/sites/default/files/2022-05/headshot-governor-tate-reeves_R.jpeg" alt="foto">
                </div>
                <div class="teacher-bio">
                    ...
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum nobis cupiditate a nesciunt deleniti illo eius vero sequi dolore, in nam rerum repellat architecto, unde optio ratione possimus nulla fuga? Eligendi, praesentium culpa labore beatae enim tenetur odio ab, nihil porro quas doloremque. Molestias, dolorem ipsa fugit corporis magnam at.
                    </p>
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim nulla praesentium dignissimos aspernatur iste facere tempora, optio ea, molestias vero similique porro doloribus quod fuga sunt eveniet repellat corrupti. Quidem maiores qui dolor dolorum enim corrupti blanditiis illo deserunt explicabo suscipit modi accusantium obcaecati debitis ipsam recusandae, libero harum nesciunt minus cumque totam reiciendis culpa molestias doloribus. Facilis, ratione excepturi.
                    </p>
                    <div class="teacher-bio-icon-grid">
                        ...
                        <a class="facebook"target="_blank" href="!#"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c5.05-.5 9-4.76 9-9.95"/></svg></a>
                        <a class="twiter" target="_blank" href="!#"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M22.46 6c-.77.35-1.6.58-2.46.69c.88-.53 1.56-1.37 1.88-2.38c-.83.5-1.75.85-2.72 1.05C18.37 4.5 17.26 4 16 4c-2.35 0-4.27 1.92-4.27 4.29c0 .34.04.67.11.98C8.28 9.09 5.11 7.38 3 4.79c-.37.63-.58 1.37-.58 2.15c0 1.49.75 2.81 1.91 3.56c-.71 0-1.37-.2-1.95-.5v.03c0 2.08 1.48 3.82 3.44 4.21a4.22 4.22 0 0 1-1.93.07a4.28 4.28 0 0 0 4 2.98a8.521 8.521 0 0 1-5.33 1.84c-.34 0-.68-.02-1.02-.06C3.44 20.29 5.7 21 8.12 21C16 21 20.33 14.46 20.33 8.79c0-.19 0-.37-.01-.56c.84-.6 1.56-1.36 2.14-2.23"/></svg></a>
                    </div>
                </div>
            </div>
            ...
            <div class="teacher-swiper">
                <div class="teacher-card">
                    <img class="teacher-img" src="https://www.ms.gov/sites/default/files/2022-05/MS_Lieutenant-Governor-Delbert-Hosemann.jpg" alt="foto">
...
.instagram:hover{
    ...
    .teacher-card:hover{
        ...
        .teacher-img{
           box-shadow: 40px 20px 40px black;
        }
    }
    .teacher-card img{
        transition: 0.5s;
    ...
    .teacher-card h2{
        ...
        color: white;
        margin-bottom: 10px;
        border-bottom: #061E3F solid 2px;
    }
    .teacher-card h3{
        color: white;
   ...
   .map-content{
    border-top: 2px solid  #043B87;
    border-bottom: 2px solid  #043B87;
    padding-top: 30px;
    padding: 50px 80px;
