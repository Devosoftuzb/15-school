                ...
                <table>
                    ...
                    <tbody v-for="i in store.pagLessonAll[store.pag]" :key="i.id">
                        <tr>
                            ...
                            <td>
                                <button @click="deleteLesson(i.id)" class="delete-btn">
                                ...
                                <button @click="getOneLesson(i.id)" class="change-btn">
                    ...
                    <form @submit.prevent="createLesson">
                        <div class="form-grid">
                            <label for="fio">
                                ...
                                <input v-model="lessons.title" required id="fio" type="text">
                            </label>
                        ...
                        <div class="form-grid">
                            <label class="yangilik_text" for="data">
                                ...
                                <input v-model="lessons.week_days" required id="data" type="text">
                            </label>
                        </div>
                    ...
                    <form @submit.prevent="editLesson">
                        ...
                        <div class="form-grid">
                            <label class="yangilik_text" for="data">
                                ...
                                <input v-model="edit.week_days" required id="data" type="text">
                            </label>
                        </div>
                        <div class="modal-footer">
                            <button class="submitBtn" type="submit">
...
const getOneLesson = (id) => {
    axios
        ...
        .then((res) => {
            ...
            edit.week_days = res.data.week_days
            edit.id = res.data.id;
